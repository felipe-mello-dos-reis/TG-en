...
For statistical analysis, the Tukey test was performed, allowing the identification of significant differences between sample groups, considering a significance level of 95\%. \textcolor{red}{The Table reftab:methods summary presents the summary of the methods used in this work.}
\textcolor{red}{TO-DO}
