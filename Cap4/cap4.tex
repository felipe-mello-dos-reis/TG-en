...
X-ray diffraction patterns after 3-day curing of the pastes at different Si/Al ratios (Figure \ref{fig:xrd_pastes}) showed a persistent amorphous hump in all compositions, indicating the presence of aluminosilicate gel (N-A-S-H).
...
% Thermodynamic modeling by Chen \cite{Chen2024} also showed that N-A-S-H gel stability peaks near this Si/Al range.  
